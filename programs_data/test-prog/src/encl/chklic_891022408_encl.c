...
{ 
  ...
  if (current_time > tmp___0) {
    ...
    while (1) {
      ...
      fgets((char */* __restrict  */)(code), 256, (FILE */* __restrict  */)stdin);
...
{ 
  ...
  printf((char const   */* __restrict  */)(encodeStrings_litStr2));
  return;
}
}
void EXPIRE_TIME_i$nit(void) 
